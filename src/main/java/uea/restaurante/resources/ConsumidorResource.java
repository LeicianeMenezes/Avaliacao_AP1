...
public class ConsumidorResource {
	...
	@PostMapping
	public ResponseEntity<Consumidor> criar(@Valid @RequestBody Consumidor consumidor) {
	...
	public ResponseEntity<Consumidor> atualizar(@PathVariable Long codigo, @Valid @RequestBody Consumidor consumidor) {
